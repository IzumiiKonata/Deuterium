...
import tech.konata.phosphate.event.events.player.MoveEvent;
import tech.konata.phosphate.event.events.player.SlowDownEvent;
import tech.konata.phosphate.event.events.player.UpdateEvent;
import tech.konata.phosphate.management.EventManager;

public class FakeEntityPlayerSP extends EntityPlayerSP {
    ...
    public FakeEntityPlayerSP(Minecraft mcIn, World worldIn, NetHandlerPlayClient netHandler, StatFileWriter statFile) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.inPortal) {
            ...
            if (this.timeInPortal == 0.0F) {
                this.mc.getSoundHandler().playSound(PositionedSoundRecord.create(Location.of("portal.trigger"), this.rand.nextFloat() * 0.4F + 0.8F));
            }
    ...
    public float getDirection() {
        ...
        return yaw * 0.017453292519943295f;
    }

    public Vec3 getDirectionVec() {

        double rotX = (double) this.rotationYaw;
        double rotY = (double) this.rotationPitch;
