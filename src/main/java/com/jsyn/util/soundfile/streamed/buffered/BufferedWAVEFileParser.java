...
//                System.out.println("ParseDataChunk");
    ...
    public static class StreamedByteDataReader {
        ...
        public StreamedByteDataReader(BufferedIFFParser parser, int totalSize, int numFrames, int samplesPerFrame, int bitsPerSample, int format) throws IOException {
            this.parser = parser;
