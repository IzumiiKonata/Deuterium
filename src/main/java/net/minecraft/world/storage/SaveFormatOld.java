...
public class SaveFormatOld implements ISaveFormat {
    private static final Logger logger = LogManager.getLogger("SaveFormatOld");
        ...
        if (file1.exists()) {
            ...
            if (file2.exists()) {
                try {
                    ...
                    CompressedStreamTools.writeCompressed(nbttagcompound, Files.newOutputStream(file2.toPath()));
                } catch (Exception exception) {
