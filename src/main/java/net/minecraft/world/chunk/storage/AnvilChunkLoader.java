...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
    ...
    public Chunk loadChunk(World worldIn, int x, int z) throws IOException {
        ...
        if (nbttagcompound == null) {
            ...
            NBTTagCompound result = CompressedStreamTools.read(datainputstream);
    ...
    private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound p_75820_3_) {
        ...
        if (list != null) {
            ...
            for (NextTickListEntry nextticklistentry : list) {
                ...
                Location resourcelocation = Block.blockRegistry.getNameForObject(nextticklistentry.getBlock());
