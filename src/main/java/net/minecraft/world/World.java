...
import tech.konata.phosphate.rendering.phosphor.mod.world.lighting.LightingEngine;
...
public abstract class World implements IBlockAccess, SharedConstants, ILightingEngineProvider {
    ...
    public void updateEntities() {
        ...
        if (!this.tileEntitiesChunkToBeRemoved.isEmpty()) {
            ...
            this.loadedTileEntityList.removeIf(isInChunk);
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        try {
            ...
            crashreportcategory.addCrashSectionThrowable("无法获取世界数据", throwable);
        }
