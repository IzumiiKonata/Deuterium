...
public class Config {
    ...
    private static String build = "CustomBuild_240912";
...
//        versioncheckthread.start();
    ...
    public static void updateTexturePackClouds() {
        ...
        if (iresourcemanager != null) {
            try {
                InputStream inputstream = iresourcemanager.getResource(Location.of("mcpatcher/color.properties")).getInputStream();
    ...
    public static InputStream getResourceStream(Location p_getResourceStream_0_) throws IOException {
        return getResourceStream(minecraft.getResourceManager(), p_getResourceStream_0_);
    }

    public static InputStream getResourceStream(IResourceManager p_getResourceStream_0_, Location p_getResourceStream_1_) throws IOException {
    ...
    public static IResource getResource(Location p_getResource_0_) throws IOException {
        return minecraft.getResourceManager().getResource(p_getResource_0_);
    }

    public static boolean hasResource(Location p_hasResource_0_) {
    ...
    public static boolean isFromDefaultResourcePack(Location p_isFromDefaultResourcePack_0_) {
    ...
    public static IResourcePack getDefiningResourcePack(Location p_getDefiningResourcePack_0_) {
        ResourcePackRepository resourcepackrepository = minecraft.getResourcePackRepository();
    ...
    public static void checkDisplaySettings() {
        ...
        if (i > 0) {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null) {
                ...
                try {
                    inputstream = Minecraft.getMinecraft().mcDefaultResourcePack.getInputStreamAssets(Location.of("icons/icon_16x16.png"));
                    inputstream1 = Minecraft.getMinecraft().mcDefaultResourcePack.getInputStreamAssets(Location.of("icons/icon_32x32.png"));
...
//                Display.update();
    ...
    public static DynamicTexture getMojangLogoTexture(DynamicTexture p_getMojangLogoTexture_0_) {
        try {
            Location resourcelocation = Location.of("textures/gui/title/mojang.png");
