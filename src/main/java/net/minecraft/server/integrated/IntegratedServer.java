...
public class IntegratedServer extends MinecraftServer {
    private static final Logger logger = LogManager.getLogger("IntegratedServer");
    ...
    private <V> V checkThreadStatus(Future<V> future) {
        while(this.isServerRunning() && this.serverThread.isAlive()) {
            try {
        ...
        logger.warn("Server thread has already exited, skipping logout process");
        return null;
    }
