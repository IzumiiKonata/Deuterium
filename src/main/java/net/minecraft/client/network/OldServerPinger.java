...
public class OldServerPinger {
    protected static final Splitter PING_RESPONSE_SPLITTER = Splitter.on('\u0000').limit(6);
    protected static final Logger logger = LogManager.getLogger("OldServerPinger");
    protected final List<NetworkManager> pingDestinations = Collections.synchronizedList(Lists.newArrayList());
...
//        server.pingToServer = -1L;
    ...
    protected void tryCompatibilityPing(final ServerData server) {
