...
public class GameSettings {
    private static final Logger logger = LogManager.getLogger("GameSettings");
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value) {
        ...
        if (settingsOption == GameSettings.Options.GUI_SCALE) {
            ...
            mc.scaledResolution = ScaledResolution.createNew(mc);
...
//            Config.updateFramebufferSize();
    ...
    private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == GameSettings.Options.RENDER_DISTANCE) {
            ...
            return /*this.ofSmoothFps ? s + Lang.getOn() : s + Lang.getOff()*/s + "NOPE";
            ...
            return /*this.ofFastRender ? s + Lang.getOn() : s + Lang.getOff()*/s + "NOPE";
...
//            printwriter.println("ofFastRender:" + this.ofFastRender);
    ...
    public enum Options {
        ...
        FRAMERATE_LIMIT("options.framerateLimit", true, false, 0.0F, 500.0F, 5.0F),
