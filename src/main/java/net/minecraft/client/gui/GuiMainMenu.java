...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    private static final Logger logger = LogManager.getLogger("GuiMainMenu");
    ...
    private static final Location splashTexts = Location.of("texts/splashes.txt");
    private static final Location minecraftTitleTextures = Location.of("textures/gui/title/minecraft.png");

    /**
     * An array of all the paths to the panorama pictures.
     */
    private static final Location[] titlePanoramaPaths = new Location[]{Location.of("textures/gui/title/background/panorama_0.png"), Location.of("textures/gui/title/background/panorama_1.png"), Location.of("textures/gui/title/background/panorama_2.png"), Location.of("textures/gui/title/background/panorama_3.png"), Location.of("textures/gui/title/background/panorama_4.png"), Location.of("textures/gui/title/background/panorama_5.png")};
