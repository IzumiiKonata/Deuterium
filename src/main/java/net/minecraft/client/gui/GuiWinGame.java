...
public class GuiWinGame extends GuiScreen {
    private static final Logger logger = LogManager.getLogger("GuiWinGame");
    private static final Location MINECRAFT_LOGO = Location.of("textures/gui/title/minecraft.png");
    private static final Location VIGNETTE_TEXTURE = Location.of("textures/misc/vignette.png");
    ...
    public void initGui() {
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                int i = 274;
                InputStream inputstream = this.mc.getResourceManager().getResource(Location.of("texts/end.txt")).getInputStream();
                ...
                inputstream = this.mc.getResourceManager().getResource(Location.of("texts/credits.txt")).getInputStream();
