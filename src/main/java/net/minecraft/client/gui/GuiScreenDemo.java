...
public class GuiScreenDemo extends GuiScreen {
    private static final Logger logger = LogManager.getLogger("GuiScreenDemo");
    private static final Location field_146348_f = Location.of("textures/gui/demo_background.png");
