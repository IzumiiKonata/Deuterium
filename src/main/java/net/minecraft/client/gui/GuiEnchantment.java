...
public class GuiEnchantment extends GuiContainer {
    /**
     * The Location containing the Enchantment GUI texture location
     */
    private static final Location ENCHANTMENT_TABLE_GUI_TEXTURE = Location.of("textures/gui/container/enchanting_table.png");

    /**
     * The Location containing the texture for the Book rendered above the enchantment table
     */
    private static final Location ENCHANTMENT_TABLE_BOOK_TEXTURE = Location.of("textures/entity/enchanting_table_book.png");
