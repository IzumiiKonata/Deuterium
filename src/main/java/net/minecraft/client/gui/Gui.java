...
public class Gui {
    public static final Location optionsBackground = Location.of("textures/gui/options_background.png");
    public static final Location statIcons = Location.of("textures/gui/container/stats_icons.png");
    public static final Location icons = Location.of("textures/gui/icons.png");
