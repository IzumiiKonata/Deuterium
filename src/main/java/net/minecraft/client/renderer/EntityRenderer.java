...
public class EntityRenderer implements IResourceManagerReloadListener {
    private static final Logger logger = LogManager.getLogger("EntityRenderer");
    private static final Location locationRainPng = Location.of("textures/environment/rain.png");
    private static final Location locationSnowPng = Location.of("textures/environment/snow.png");
    ...
    private Location locationLightMap;
    ...
    private static final Location[] shaderResourceLocations = new Location[]{Location.of("shaders/post/notch.json"), Location.of("shaders/post/fxaa.json"), Location.of("shaders/post/art.json"), Location.of("shaders/post/bumpy.json"), Location.of("shaders/post/blobs2.json"), Location.of("shaders/post/pencil.json"), Location.of("shaders/post/color_convolve.json"), Location.of("shaders/post/deconverge.json"), Location.of("shaders/post/flip.json"), Location.of("shaders/post/invert.json"), Location.of("shaders/post/ntsc.json"), Location.of("shaders/post/outline.json"), Location.of("shaders/post/phosphor.json"), Location.of("shaders/post/scan_pincushion.json"), Location.of("shaders/post/sobel.json"), Location.of("shaders/post/bits.json"), Location.of("shaders/post/desaturate.json"), Location.of("shaders/post/green.json"), Location.of("shaders/post/blur.json"), Location.of("shaders/post/wobble.json"), Location.of("shaders/post/blobs.json"), Location.of("shaders/post/antialias.json"), Location.of("shaders/post/creeper.json"), Location.of("shaders/post/spider.json")};
    ...
    public EntityRenderer(Minecraft mcIn, IResourceManager resourceManagerIn) {
        ...
        this.lightmapTexture.setClearable(false);
    ...
    public void updateRenderer() {
        ...
        Vec3 positionEyes = mc.getRenderViewEntity().getPositionEyes(1.0F);
        float f2 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(positionEyes.xCoord), MathHelper.floor_double(positionEyes.yCoord), MathHelper.floor_double(positionEyes.zCoord));
    ...
    private Animation smoothAnimation = new Animation(Easing.EASE_OUT_CUBIC, Duration.ofMillis(1000));
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            CameraPositions cp = ModuleManager.cameraPositions;
            if (cp.isEnabled() && cp.smoothThirdPerson.getValue()) {
                if (prevView != this.mc.gameSettings.thirdPersonView && prevView == 0) {
                    smoothAnimation = new Animation(Easing.EASE_OUT_CUBIC, Duration.ofMillis((long) (1000 - (900 * ((cp.smooth.getValue() - cp.smooth.getMinimum()) / (cp.smooth.getMaximum() - cp.smooth.getMinimum()))))));
                    smoothAnimation.setStartValue(1);
                    smoothAnimation.setValue(1);
                }

                this.thirdPersonDistance = (float) smoothAnimation.run(4);
            } else {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                float f1 = /*entity.rotationYaw*/Perspective.getCameraYaw();
                float f2 = /*entity.rotationPitch*/Perspective.getCameraPitch();
                ...
                GlStateManager.rotate(/*entity.rotationPitch*/Perspective.getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(/*entity.rotationYaw*/Perspective.getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
                GlStateManager.rotate(f1 - /*entity.rotationYaw*/Perspective.getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - /*entity.rotationPitch*/Perspective.getCameraPitch(), 1.0F, 0.0F, 0.0F);
    ...
    public void enableLightmap() {
        ...
        if (this.mc.getTextureManager().getTexture(this.locationLightMap) == TextureUtil.missingTexture) {
            this.locationLightMap = this.mc.getTextureManager().getDynamicTextureLocation("lightMap", this.lightmapTexture);
        }
    ...
    private void updateLightmap(float partialTicks) {
        ...
        if (ModuleManager.nightVision.isEnabled() && this.patcher$createdLightmap) {
            return;
        }
    ...
    public boolean patcher$createdLightmap;
    ...
    public void onMouseEvent(double dX, double dY) {
        ...
        if (Perspective.overrideMouse(dX, dY) && flag) {
            float f = this.mc.gameSettings.mouseSensitivity * 0.6F + 0.2F;
            float f1 = f * f * f * 8.0F;
            ...
            if (this.mc.gameSettings.smoothCamera) {
                ...
                float f4 = mc.timer.renderPartialTicks - this.smoothCamPartialTicks;
                this.smoothCamPartialTicks = mc.timer.renderPartialTicks;
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.gameSettings.smoothCamera) {
            ...
            float f4 = mc.timer.renderPartialTicks - this.smoothCamPartialTicks;
            this.smoothCamPartialTicks = mc.timer.renderPartialTicks;
            this.mc.thePlayer.setAngles(this.smoothCamFilterX * f4, this.smoothCamFilterY * f4 * (float) i);
        }
...
//                    GlStateManager.popAttrib();
                    ...
                    SharedRenderingConstants.render2D(true);
...
//                    this.mc.currentScreen.drawScreen(k1, l1, partialTicks);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        ITextureObject texture = this.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture);
        if (texture == TextureUtil.missingTexture || texture == null) {
            mc.getTextureManager().loadTickableTexture(TextureMap.locationBlocksTexture, mc.getTextureMapBlocks());
            texture = mc.getTextureMapBlocks();
        }
        ...
        texture.setBlurMipmap(false, this.mc.gameSettings.mipmapLevels > 0);
...
//        SharedRenderingConstants.BLOOM.clear();
//        SharedRenderingConstants.UI_BLOOM_RUNNABLES.clear();
//        SharedRenderingConstants.BLUR.clear();
...
//        GlStateManager.popAttrib();
    ...
    private void addRainParticles() {
        ...
        WorldTime worldTime = ModuleManager.worldTime;
        boolean bEnabled = worldTime.isEnabled();

//        boolean bRain = worldTime.weather.getValue() == WorldTime.Weather.Rain || worldTime.weather.getValue() == WorldTime.Weather.Thunder;
        boolean bSnow = worldTime.weather.getValue() == WorldTime.Weather.Snow;

        if (!Config.isRainFancy()) {
            f /= 2.0F;
        }

        if (f != 0.0F && Config.isRainSplash() && (!bEnabled || !bSnow)) {
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        boolean bRain = worldTime.weather.getValue() == WorldTime.Weather.Rain;
        boolean bSnow = worldTime.weather.getValue() == WorldTime.Weather.Snow;
        ...
        if (f5 > 0.0F) {
            ...
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            GlStateManager.alphaFunc(516, 0.1F);
            double renderX = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double) partialTicks;
            double renderY = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double) partialTicks;
            double renderZ = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double) partialTicks;
            int renderYFloored = MathHelper.floor_double(renderY);
            ...
            worldrenderer.setTranslation(-renderX, -renderY, -renderZ);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos();

            for (int particleZ = posZ - particleAmount; particleZ <= posZ + particleAmount; ++particleZ) {
                for (int particleX = posX - particleAmount; particleX <= posX + particleAmount; ++particleX) {
                    int i2 = (particleZ - posZ + 16) * 32 + particleX - posX + 16;
                    double d3 = (double) this.rainXCoords[i2] * 0.5D;
                    double d4 = (double) this.rainYCoords[i2] * 0.5D;
                    blockpos$mutableblockpos.set(particleX, 0, particleZ);
                    BiomeGenBase biomegenbase = world.getBiomeGenForCoords(blockpos$mutableblockpos);

                    if (biomegenbase.canRain() || biomegenbase.getEnableSnow() || (bEnabled && (bSnow || bRain))) {
                        int precipitationHeight = world.getPrecipitationHeight(blockpos$mutableblockpos).getY();
                        int pMinimum = posY - particleAmount;
                        int pMaximum = posY + particleAmount;

                        if (pMinimum < precipitationHeight) {
                            pMinimum = precipitationHeight;
                        }

                        if (pMaximum < precipitationHeight) {
                        ...
                        if (pMinimum != pMaximum) {
                            ...
                            blockpos$mutableblockpos.set(particleX, pMinimum, particleZ);
                            float f1 = biomegenbase.getFloatTemperature(blockpos$mutableblockpos);

                            // rain
                            boolean bTemp = world.getWorldChunkManager().getTemperatureAtHeight(f1, precipitationHeight) >= 0.15F;
                            if ((!bEnabled && bTemp) || (bEnabled && bRain)) {
                                if (j1 != 0) {
                                    if (j1 >= 0) {
                                        tessellator.draw();
                                    }
                                ...
                                double d5 = ((double) (this.rendererUpdateCount + particleX * particleX * 3121 + particleX * 45238971 + particleZ * particleZ * 418711 + particleZ * 13761 & 31) + (double) partialTicks) / 32.0D * (3.0D + this.random.nextDouble());
                                double d6 = (double) ((float) particleX + 0.5F) - entity.posX;
                                double d7 = (double) ((float) particleZ + 0.5F) - entity.posZ;
                                float f2 = MathHelper.sqrt_double(d6 * d6 + d7 * d7) / (float) particleAmount;
                                float f3 = ((1.0F - f2 * f2) * 0.5F + 0.5F) * f5;
                                blockpos$mutableblockpos.set(particleX, capHeight, particleZ);
                                int j3 = world.getCombinedLight(blockpos$mutableblockpos, 0);
                                int k3 = j3 >> 16 & 65535;
                                int l3 = j3 & 65535;
                                worldrenderer.pos((double) particleX - d3 + 0.5D, pMinimum, (double) particleZ - d4 + 0.5D).tex(0.0D, (double) pMinimum * 0.25D + d5).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                worldrenderer.pos((double) particleX + d3 + 0.5D, pMinimum, (double) particleZ + d4 + 0.5D).tex(1.0D, (double) pMinimum * 0.25D + d5).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                worldrenderer.pos((double) particleX + d3 + 0.5D, pMaximum, (double) particleZ + d4 + 0.5D).tex(1.0D, (double) pMaximum * 0.25D + d5).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                worldrenderer.pos((double) particleX - d3 + 0.5D, pMaximum, (double) particleZ - d4 + 0.5D).tex(0.0D, (double) pMaximum * 0.25D + d5).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                            }
                            ...
                            if ((!bEnabled && !bTemp) || (bEnabled && bSnow)){
                                ...
                                double d11 = (double) ((float) particleX + 0.5F) - entity.posX;
                                double d12 = (double) ((float) particleZ + 0.5F) - entity.posZ;
                                float f6 = MathHelper.sqrt_double(d11 * d11 + d12 * d12) / (float) particleAmount;
                                float f4 = ((1.0F - f6 * f6) * 0.3F + 0.5F) * f5;
                                blockpos$mutableblockpos.set(particleX, capHeight, particleZ);
                                int i4 = (world.getCombinedLight(blockpos$mutableblockpos, 0) * 3 + 15728880) / 4;
                                int j4 = i4 >> 16 & 65535;
                                int k4 = i4 & 65535;
                                worldrenderer.pos((double) particleX - d3 + 0.5D, pMinimum, (double) particleZ - d4 + 0.5D).tex(0.0D + d9, (double) pMinimum * 0.25D + d8 + d10).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                                worldrenderer.pos((double) particleX + d3 + 0.5D, pMinimum, (double) particleZ + d4 + 0.5D).tex(1.0D + d9, (double) pMinimum * 0.25D + d8 + d10).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                                worldrenderer.pos((double) particleX + d3 + 0.5D, pMaximum, (double) particleZ + d4 + 0.5D).tex(1.0D + d9, (double) pMaximum * 0.25D + d8 + d10).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                                worldrenderer.pos((double) particleX - d3 + 0.5D, pMaximum, (double) particleZ - d4 + 0.5D).tex(0.0D + d9, (double) pMaximum * 0.25D + d8 + d10).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                            }
                        }
                    }
                }
...
//        Config.checkDisplayMode();
    ...
    public boolean setFxaaShader(int p_setFxaaShader_1_) {
        if (!OpenGlHelper.isFramebufferEnabled()) {
            ...
            this.loadShader(Location.of("shaders/post/fxaa_of_" + p_setFxaaShader_1_ + "x.json"));
