...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    private static final Logger logger = LogManager.getLogger("RenderGlobal");
    private static final Location locationMoonPhasesPng = Location.of("textures/environment/moon_phases.png");
    private static final Location locationSunPng = Location.of("textures/environment/sun.png");
    private static final Location locationCloudsPng = Location.of("textures/environment/clouds.png");
    private static final Location locationEndSkyPng = Location.of("textures/environment/end_sky.png");
    private static final Location locationForcefieldPng = Location.of("textures/misc/forcefield.png");
    ...
    public void makeEntityOutlineShader() {
        if (OpenGlHelper.shadersSupported) {
            ...
            Location resourcelocation = Location.of("shaders/post/entity_outline.json");
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                this.entityOutlineFramebuffer.framebufferClearNoBinding();
            ...
            while (!deque.isEmpty()) {
                ...
                for (EnumFacing enumfacing : flag1 ? ChunkVisibility.getFacingsNotOpposite(renderglobal$containerlocalrenderinformation5.setFacing) : EnumFacing.VALUES) {
                    if (!flag1 || enumfacing1 == null || compiledchunk.isVisible(enumfacing1.getOpposite(), enumfacing)) {
                        ...
                        if (processedChunks.contains(renderchunk4))
                            continue;
                        ...
                        if (renderchunk4 != null && renderchunk4.setFrameIndex(frameCount) && renderchunk4.isBoundingBoxInFrustum(camera, frameCount)) {
                            ...
                            processedChunks.add(renderchunk4);
...
//            partialTicks = 0.0f;
    ...
    public void playRecord(String recordName, BlockPos blockPosIn) {
        ...
        if (recordName != null) {
            ...
            PositionedSoundRecord positionedsoundrecord = PositionedSoundRecord.create(Location.of(recordName), (float) blockPosIn.getX(), (float) blockPosIn.getY(), (float) blockPosIn.getZ());
        ...
        switch (sfxType) {
            ...
            case 2001:
                ...
                if (block.getMaterial() != Material.air) {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(Location.of(block.stepSound.getBreakSound()), (block.stepSound.getVolume() + 1.0F) / 2.0F, block.stepSound.getFrequency() * 0.8F, (float) blockPosIn.getX() + 0.5F, (float) blockPosIn.getY() + 0.5F, (float) blockPosIn.getZ() + 0.5F));
                }
