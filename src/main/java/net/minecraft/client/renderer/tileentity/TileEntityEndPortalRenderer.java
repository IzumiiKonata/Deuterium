...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer<TileEntityEndPortal> {
    private static final Location END_SKY_TEXTURE = Location.of("textures/environment/end_sky.png");
    private static final Location END_PORTAL_TEXTURE = Location.of("textures/entity/end_portal.png");
