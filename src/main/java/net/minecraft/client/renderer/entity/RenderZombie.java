...
public class RenderZombie extends RenderBiped<EntityZombie> {
    private static final Location zombieTextures = Location.of("textures/entity/zombie/zombie.png");
    private static final Location zombieVillagerTextures = Location.of("textures/entity/zombie/zombie_villager.png");
     ...
     */
    protected Location getEntityTexture(EntityZombie entity) {
