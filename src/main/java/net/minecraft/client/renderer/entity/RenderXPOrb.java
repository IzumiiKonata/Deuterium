...
public class RenderXPOrb extends Render<EntityXPOrb> {
    private static final Location experienceOrbTextures = Location.of("textures/entity/experience_orb.png");
     ...
     */
    protected Location getEntityTexture(EntityXPOrb entity) {
