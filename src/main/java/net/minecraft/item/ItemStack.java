...
public final class ItemStack {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
        Location resourcelocation = Item.itemRegistry.getNameForObject(this.item);
        ...
        if (this.hasTagCompound()) {
            ...
            if (this.stackTagCompound.hasKey("display", 10)) {
                ...
                if (nbttagcompound.hasKey("color", 3)) {
                    if (advanced) {
                        list.add("Color: #" + String.format("%06X", nbttagcompound.getInteger("color")).toUpperCase());
                    } else {
    ...
    public String getName() {
        return ItemStack.this.getUnlocalizedName();
    }

    public int getStackSize() {
        return ItemStack.this.stackSize;
    }

    public int getDurability() {
        return ItemStack.this.itemDamage;
    }

    public int getMaxDurability() {
        return ItemStack.this.getMaxDamage();
    }
