...
public class MessageDeserializer extends ByteToMessageDecoder {
    private static final Logger logger = LogManager.getLogger("MessageDeserializer");
            ...
            if (packet == null) {
                ...
                if (packetbuffer.readableBytes() > 0) {
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug(" IN: [{}:{}] {}", p_decode_1_.channel().attr(NetworkManager.attrKeyConnectionState).get(), i, packet.getClass().getName());
                    }
                }
            }
        }
