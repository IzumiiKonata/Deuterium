...
public class CustomItems {
    ...
    private static void readCitProperties(final String fileName) {
        try {
            final Location resourcelocation = Location.of(fileName);
    ...
    private static void update(final IResourcePack rp) {
        ...
        for (final CustomItemProperties[] acustomitemproperties : itemProperties) {
            if (acustomitemproperties != null) {
                Arrays.sort(acustomitemproperties, comparator);
            }
        }
        for (final CustomItemProperties[] acustomitemproperties1 : enchantmentProperties) {
    ...
    private static void addAll(final CustomItemProperties[][] cipsArr, final List<CustomItemProperties> list) {
        if (cipsArr != null) {
            for (final CustomItemProperties[] acustomitemproperties : cipsArr) {
                if (acustomitemproperties != null) {
                    for (final CustomItemProperties customitemproperties : acustomitemproperties) {
                        if (customitemproperties != null) {
    ...
    private static List makePropertyList(final CustomItemProperties[][] propsArr) {
        ...
        if (propsArr != null) {
            for (final CustomItemProperties[] acustomitemproperties : propsArr) {
                List list1 = null;
                if (acustomitemproperties != null) {
    ...
    private static CustomItemProperties[][] propertyListToArray(final List list) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (subList != null) {
                final CustomItemProperties[] acustomitemproperties1 = (CustomItemProperties[]) subList.toArray(new CustomItemProperties[0]);
    ...
    public static IBakedModel getCustomItemModel(final ItemStack itemStack, final IBakedModel model, final Location modelLocation, final boolean fullModel) {
    ...
    public static boolean bindCustomArmorTexture(final ItemStack itemStack, final int layer, final String overlay) {
        if (itemProperties == null) {
            ...
            final Location resourcelocation = getCustomArmorLocation(itemStack, layer, overlay);
    ...
    private static Location getCustomArmorLocation(final ItemStack itemStack, final int layer, final String overlay) {
        ...
        if (customitemproperties == null) {
            ...
            if (!(item instanceof ItemArmor)) {
                ...
                final Location resourcelocation = (Location) customitemproperties.mapTextureLocations.get(s1);
