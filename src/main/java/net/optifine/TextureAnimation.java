...
public class TextureAnimation {
    ...
    public TextureAnimation(final String texFrom, final byte[] srcData, final String texTo, final Location locTexTo, final int dstX, final int dstY, final int frameWidth, final int frameHeight, final Properties props) {
        this.srcTex = texFrom;
        this.dstTex = texTo;
        ...
        if (j + i <= this.imageData.limit()) {
            ...
            if (k + i <= this.imageData.limit()) {
                ...
                for (int l = 0; l < i; ++l) {
                    ...
                    final int k1 = this.mix(i1, j1, kk);
