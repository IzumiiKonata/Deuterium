...
public class GuiShaders extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                new GuiButton(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.format("gui.done")));
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        this.shaderList.mouseClickMove(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
    }

    @Override
    public void handleDWheel(int wheel) {
        this.shaderList.handleDWheel(wheel);
    }
