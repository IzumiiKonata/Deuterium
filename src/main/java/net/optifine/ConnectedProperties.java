...
public class ConnectedProperties {
        ...
        if (this.tiles == null) return null;
            ...
            if (map.isEmpty()) return null;
                ...
                for (int k = 0; k < aint.length; ++k) {
                    aint[k] = -1;
                    if (map.containsKey(k)) aint[k] = map.get(k);
                }
                return aint;
            }
        }
    ...
    private String[] parseTileNames(final String str) {
        if (str == null) return null;
            ...
            final String[] astring2 = ((String[]) list.toArray(new String[0]));
        ...
        if (tileNames == null) return null;
            ...
            for (final String s : tileNames) {
                ...
                if (skipTiles && s3.endsWith("<skip>.png")) list.add(null);
                    ...
                    final Location resourcelocation1 = Location.of(s1, s3);
                    ...
                    final Location resourcelocation2 = Location.of(s1, s5);
    ...
    public int getMetadataMax() {
        ...
        if (this.matchBlocks != null) for (final MatchBlock matchblock : this.matchBlocks) {
