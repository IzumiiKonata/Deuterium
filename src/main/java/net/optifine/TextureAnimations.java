...
public class TextureAnimations {
    ...
    private static TextureAnimation[] getTextureAnimations(final IResourcePack[] rps) {
        ...
        for (final IResourcePack iresourcepack : rps) {
            ...
            for (final String s : astring) {
                ...
                try {
                    ...
                    if (textureanimation != null) {
                        final Location resourcelocation1 = Location.of(textureanimation.getDstTex());
    ...
    private static TextureAnimation makeTextureAnimation(final Properties props, final Location propLoc) {
    ...
    private static byte[] loadImage(final String name, final int targetWidth) {
        ...
        try {
            final Location resourcelocation = Location.of(name);
            final InputStream inputstream = Config.getResourceStream(resourcelocation);
            if (inputstream == null) {
                return null;
            } else {
