...
public class ModelResourceLocation extends Location {
    ...
    public ModelResourceLocation(Location p_i46080_1_, String p_i46080_2_) {
    ...
    protected static String[] parsePathString(String p_177517_0_) {
        ...
        System.arraycopy(Location.splitObjectName(s), 0, astring, 0, 2);
        return astring;
    }
