...
public class ChunkRenderWorker implements Runnable {
    private static final Logger LOGGER = LogManager.getLogger("ChunkRenderWorker");
    ...
    public void run() {
        while (true) {
            try {
                ...
                CrashReport crashreport = CrashReport.makeCrashReport(throwable, "区块批处理");
            ...
            Futures.addCallback(listenablefuture, new FutureCallback<>() {
                ...
                public void onFailure(Throwable p_onFailure_1_) {
                    ...
                    if (!(p_onFailure_1_ instanceof CancellationException) && !(p_onFailure_1_ instanceof InterruptedException)) {
                        Minecraft.getMinecraft().crashed(CrashReport.makeCrashReport(p_onFailure_1_, "区块渲染"));
                    }
                }
