...
public class RenderDragon extends RenderLiving<EntityDragon> {
    ...
    private static final Location enderDragonExplodingTextures = Location.of("textures/entity/enderdragon/dragon_exploding.png");
    private static final Location enderDragonTextures = Location.of("textures/entity/enderdragon/dragon.png");
     ...
     */
    protected Location getEntityTexture(EntityDragon entity) {
