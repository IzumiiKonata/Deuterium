...
public class TextureAtlasSprite {
    ...
    protected static TextureAtlasSprite makeAtlasSprite(Location spriteResourceLocation) {
    ...
    public boolean hasCustomLoader(IResourceManager p_hasCustomLoader_1_, Location p_hasCustomLoader_2_) {
        return false;
    }

    public boolean load(IResourceManager p_load_1_, Location p_load_2_) {
        return true;
    }
    ...
    private void loadShadersSprites() {
        ...
        if (Shaders.configSpecularMap) {
            ...
            Location resourcelocation1 = Location.of(s1);
