...
public class RenderGuardian extends RenderLiving<EntityGuardian> {
    private static final Location GUARDIAN_TEXTURE = Location.of("textures/entity/guardian.png");
    private static final Location GUARDIAN_ELDER_TEXTURE = Location.of("textures/entity/guardian_elder.png");
    private static final Location GUARDIAN_BEAM_TEXTURE = Location.of("textures/entity/guardian_beam.png");
    int field_177115_a;
     ...
     */
    protected Location getEntityTexture(EntityGuardian entity) {
