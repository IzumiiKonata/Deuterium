...
public class RenderPainting extends Render<EntityPainting> {
    private static final Location KRISTOFFER_PAINTING_TEXTURE = Location.of("textures/painting/paintings_kristoffer_zetterstrand.png");
     ...
     */
    protected Location getEntityTexture(EntityPainting entity) {
