...
public class ModelBlockDefinition {
    ...
    public static class Variant {
        ...
        public Variant(Location modelLocationIn, ModelRotation modelRotationIn, boolean uvLockIn, int weightIn) {
        ...
        public static class Deserializer implements JsonDeserializer<ModelBlockDefinition.Variant> {
            ...
            private Location makeModelLocation(String p_178426_1_) {
                Location resourcelocation = Location.of(p_178426_1_);
                resourcelocation = Location.of(resourcelocation.getResourceDomain(), "block/" + resourcelocation.getResourcePath());
