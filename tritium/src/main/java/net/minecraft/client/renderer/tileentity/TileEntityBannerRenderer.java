...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer<TileEntityBanner> {
    ...
    private static final Location BANNERTEXTURES = Location.of("textures/entity/banner_base.png");
    ...
    public void renderTileEntityAt(TileEntityBanner te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        Location resourcelocation = this.func_178463_a(te);
    ...
    private Location func_178463_a(TileEntityBanner bannerObj) {
        ...
        if (s.isEmpty()) {
            ...
            if (tileentitybannerrenderer$timedbannertexture == null) {
                ...
                tileentitybannerrenderer$timedbannertexture.bannerTexture = Location.of(s);
