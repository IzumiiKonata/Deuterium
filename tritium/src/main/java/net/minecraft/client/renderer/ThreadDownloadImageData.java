...
public class ThreadDownloadImageData extends SimpleTexture {
    private static final Logger logger = LogManager.getLogger("ThreadDownloadImageData");
    ...
    public ThreadDownloadImageData(File cacheFileIn, String imageUrlIn, Location textureResourceLocation, IImageBuffer imageBufferIn) {
