...
public class ModelBlock {
    private static final Logger LOGGER = LogManager.getLogger("ModelBlock");
    ...
    protected ModelBlock(Location parentLocationIn, Map<String, String> texturesIn, boolean ambientOcclusionIn, boolean gui3dIn, ItemCameraTransforms cameraTransformsIn) {
        this(parentLocationIn, Collections.emptyList(), texturesIn, ambientOcclusionIn, gui3dIn, cameraTransformsIn);
    }

    private ModelBlock(Location parentLocationIn, List<BlockPart> elementsIn, Map<String, String> texturesIn, boolean ambientOcclusionIn, boolean gui3dIn, ItemCameraTransforms cameraTransformsIn) {
        this.name = "";
    ...
    public void getParentFromMap(Map<Location, ModelBlock> p_178299_1_) {
    ...
    public static void checkModelHierarchy(Map<Location, ModelBlock> p_178312_0_) {
    ...
    public static class Deserializer implements JsonDeserializer<ModelBlock> {
        public ModelBlock deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            if (flag1 && flag) {
                ...
                return flag1 ? new ModelBlock(Location.of(s), map, flag2, true, itemcameratransforms) : new ModelBlock(list, map, flag2, true, itemcameratransforms);
            }
        }
