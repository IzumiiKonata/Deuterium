...
public class LayeredColorMaskTexture extends AbstractTexture {
     ...
     */
    private static final Logger LOG = LogManager.getLogger("LayeredColorMaskTexture");

    /**
     * The location of the texture.
     */
    private final Location textureLocation;
    private final List<String> field_174949_h;
    private final List<EnumDyeColor> field_174950_i;

    public LayeredColorMaskTexture(Location textureLocationIn, List<String> p_i46101_2_, List<EnumDyeColor> p_i46101_3_) {
