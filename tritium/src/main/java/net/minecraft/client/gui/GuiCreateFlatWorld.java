...
public class GuiCreateFlatWorld extends GuiScreen {
    ...
    public void handleMouseInput(int button, boolean pressed) {
        ...
        this.createFlatWorldListSlotGui.handleMouseInput(button, pressed);
    }

    @Override
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        this.createFlatWorldListSlotGui.mouseClickMove(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
    }

    @Override
    public void handleDWheel(int wheel) {
        this.createFlatWorldListSlotGui.handleDWheel(wheel);
    }
