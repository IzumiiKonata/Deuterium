...
public class GuiBeacon extends GuiContainer {
    private static final Location beaconGuiTextures = Location.of("textures/gui/container/beacon.png");
    ...
    static class Button extends GuiButton {
        private final Location field_146145_o;
        private final int field_146144_p;
        private final int field_146143_q;
        private boolean field_146142_r;

        protected Button(int p_i1077_1_, int p_i1077_2_, int p_i1077_3_, Location p_i1077_4_, int p_i1077_5_, int p_i1077_6_) {
