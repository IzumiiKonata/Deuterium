...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    private static final Logger logger = LogManager.getLogger("ServerListEntryNormal");
    private static final ThreadPoolExecutor field_148302_b = new ScheduledThreadPoolExecutor(5, (new ThreadFactoryBuilder()).setNameFormat("Server Pinger #%d").setDaemon(true).build());
    private static final Location UNKNOWN_SERVER = Location.of("textures/misc/unknown_server.png");
    private static final Location SERVER_SELECTION_BUTTONS = Location.of("textures/gui/server_selection.png");
    private final GuiMultiplayer owner;
    private final Minecraft mc;
    private final ServerData server;
    private final Location serverIcon;
    ...
    protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData serverIn) {
        ...
        this.serverIcon = Location.of("servers/" + serverIn.serverIP + "/icon");
    ...
    protected void drawTextureAt(int p_178012_1_, int p_178012_2_, Location p_178012_3_) {
