...
public class GuiContainerCreative extends InventoryEffectRenderer {
     ...
     */
    private static final Location creativeInventoryTabs = Location.of("textures/gui/container/creative_inventory/tabs.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager().bindTexture(Location.of("textures/gui/container/creative_inventory/tab_" + creativetabs.getBackgroundImageName()));
