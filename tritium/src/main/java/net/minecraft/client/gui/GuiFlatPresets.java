...
public class GuiFlatPresets extends GuiScreen {
    ...
    public void handleMouseInput(int button, boolean pressed) {
        ...
        this.field_146435_s.handleMouseInput(button, pressed);
    }

    @Override
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        this.field_146435_s.mouseClickMove(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
    }

    @Override
    public void handleDWheel(int wheel) {
        this.field_146435_s.handleDWheel(wheel);
    }
