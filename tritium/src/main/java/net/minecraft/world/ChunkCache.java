...
//        }
        ...
        // copied from https://github.com/embeddedt/VintageFix/blob/main/src/main/java/org/embeddedt/vintagefix/mixin/allocation_rate/MixinChunkCache.java
        ...
        if (type == EnumSkyBlock.SKY && this.worldObj.provider.getHasNoSky()) {
            ...
            if (this.getBlockState(pos).getBlock().getUseNeighborBrightness()) {
                ...
                for (EnumFacing enumfacing : EnumFacing.VALUES) {
                    offsetPos.set(pos.getX() + enumfacing.getFrontOffsetX(), pos.getY() + enumfacing.getFrontOffsetY(), pos.getZ() + enumfacing.getFrontOffsetZ());
