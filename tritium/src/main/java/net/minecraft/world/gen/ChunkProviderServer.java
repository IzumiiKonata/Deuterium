...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public final Long2ObjectMap<Chunk> id2ChunkMap = new Long2ObjectOpenHashMap<>();
            ...
            if (chunk == null) {
                if (this.serverChunkGenerator == null) {
                    ...
                    try {
                        ...
                        CrashReport crashreport = CrashReport.makeCrashReport(throwable, "生成新区块时出现异常");
                        CrashReportCategory crashreportcategory = crashreport.makeCategory("要生成的区块");
