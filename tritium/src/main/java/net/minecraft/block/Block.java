...
public class Block {
    ...
    public static Block getBlockFromName(String name) {
        Location resourcelocation = Location.of(name);
    ...
    private static void registerBlock(int id, Location textualID, Block block_) {
        blockRegistry.register(id, textualID, block_);
    }

    private static void registerBlock(int id, String textualID, Block block_) {
        registerBlock(id, Location.of(textualID), block_);
    }
