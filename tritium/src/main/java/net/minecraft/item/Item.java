...
public class Item {
    public static final RegistryNamespaced<Location, Item> itemRegistry = new RegistryNamespaced<>();
    ...
    public static Item getByNameOrId(String id) {
        Item item = itemRegistry.getObject(Location.of(id));
    ...
    private static void registerItem(int id, String textualID, Item itemIn) {
        registerItem(id, Location.of(textualID), itemIn);
    }

    private static void registerItem(int id, Location textualID, Item itemIn) {
