...
public class CompressedStreamTools {
    ...
    public static void write(NBTTagCompound p_74795_0_, File p_74795_1_) throws IOException {
        ...
        try (DataOutputStream dataoutputstream = new DataOutputStream(Files.newOutputStream(p_74795_1_.toPath()))) {
    ...
    private static NBTBase func_152455_a(DataInput p_152455_0_, int p_152455_1_, NBTSizeTracker p_152455_2_) throws IOException {
        ...
        if (b0 == 0) {
            ...
            try {
                ...
                CrashReport crashreport = CrashReport.makeCrashReport(ioexception, "加载NBT数据");
                CrashReportCategory crashreportcategory = crashreport.makeCategory("NBT 标签");
                crashreportcategory.addCrashSection("标签名称", "[UNNAMED TAG]");
                crashreportcategory.addCrashSection("标签类型", b0);
