...
public abstract class EntityLivingBase extends Entity {
    ...
    public boolean inSight(double posX, double posY, double posZ) {
        return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double) this.getEyeHeight(), this.posZ), new Vec3(posX, posY, posZ)) == null;
    }
    ...
    public void setJumpMovementFactor(float factor) {
        this.jumpMovementFactor = factor;
    }
