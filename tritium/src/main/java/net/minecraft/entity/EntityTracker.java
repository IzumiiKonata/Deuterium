...
public class EntityTracker {
    private static final Logger logger = LogManager.getLogger("EntityTracker");
    private final WorldServer theWorld;
    private final Set<EntityTrackerEntry> trackedEntities = Sets.newHashSet();
    private final Int2ObjectMap<EntityTrackerEntry> trackedEntityHashTable = new Int2ObjectOpenHashMap<>();
