...
public class CustomEntityModelParser {
    ...
    private static void processExternalModel(JsonObject elem, Map mapModelJsons, String basePath) {
        ...
        if (s != null) {
            Location resourcelocation = getResourceLocation(basePath, s, ".jpm");
    ...
    public static Location getResourceLocation(String basePath, String path, String extension) {
    ...
    public static JsonObject loadJson(Location location) throws IOException, JsonParseException {
