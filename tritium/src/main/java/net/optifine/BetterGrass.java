...
public class BetterGrass {
    ...
    private static void loadProperties(final TextureMap textureMap) {
        ...
        spriteGrass = textureMap.registerSprite(Location.of("blocks/grass_top"));
        spriteGrassSide = textureMap.registerSprite(Location.of("blocks/grass_side"));
        spriteMycelium = textureMap.registerSprite(Location.of("blocks/mycelium_top"));
        spritePodzol = textureMap.registerSprite(Location.of("blocks/dirt_podzol_top"));
        spriteSnow = textureMap.registerSprite(Location.of("blocks/snow"));
        spritesLoaded = true;
    ...
    private static TextureAtlasSprite registerSprite(final Properties props, final String key, final String textureDefault, final TextureMap textureMap) {
        ...
        final Location resourcelocation = Location.of("textures/" + s + ".png");
