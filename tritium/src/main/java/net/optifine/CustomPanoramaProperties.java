...
public class CustomPanoramaProperties {
    ...
    private final Location[] panoramaLocations;
    ...
    public CustomPanoramaProperties(final String path, final Properties props) {
        ...
        this.path = path;
        this.panoramaLocations = new Location[6];
        for (int i = 0; i < this.panoramaLocations.length; ++i) {
            this.panoramaLocations[i] = Location.of(path + "/panorama_" + i + ".png");
        }
    ...
    public Location[] getPanoramaLocations() {
