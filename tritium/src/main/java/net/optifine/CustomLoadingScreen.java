...
public class CustomLoadingScreen {
    private final Location locationTexture;
    private int scaleMode = 0;
    private int scale = 2;
    private final boolean center;

    public CustomLoadingScreen(final Location locationTexture, final int scaleMode, final int scale, final boolean center) {
    ...
    public static CustomLoadingScreen parseScreen(final String path, final int dimId, final Properties props) {
        final Location resourcelocation = Location.of(path);
