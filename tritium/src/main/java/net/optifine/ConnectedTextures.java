...
public class ConnectedTextures {
        ...
        if (!cp.matchesBlock(blockState.getBlockId(), k)) return null;
            ...
            if (cp.heights != null && !cp.heights.isInRange(i1)) return null;
                ...
                return switch (cp.method) {
                    case 1 ->
                            getQuads(getConnectedTextureCtm(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j, renderEnv), quad, renderEnv);
                    case 2 ->
                            getQuads(getConnectedTextureHorizontal(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j), quad, renderEnv);
                    case 3 ->
                            getQuads(getConnectedTextureTop(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j), quad, renderEnv);
                    case 4 ->
                            getQuads(getConnectedTextureRandom(cp, blockAccess, blockState, blockPos, side), quad, renderEnv);
                    case 5 -> getQuads(getConnectedTextureRepeat(cp, blockPos, side), quad, renderEnv);
                    case 6 ->
                            getQuads(getConnectedTextureVertical(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j), quad, renderEnv);
                    case 7 -> getQuads(getConnectedTextureFixed(cp), quad, renderEnv);
                    case 8 ->
                            getQuads(getConnectedTextureHorizontalVertical(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j), quad, renderEnv);
                    case 9 ->
                            getQuads(getConnectedTextureVerticalHorizontal(cp, blockAccess, blockState, blockPos, i, side, textureatlassprite, j), quad, renderEnv);
                    case 10 -> {
                        if (pass == 0)
                            yield getConnectedTextureCtmCompact(cp, blockAccess, blockState, blockPos, i, side, quad, j, renderEnv);
                        else
                            yield null;
                    }
                    case 11 ->
                            getConnectedTextureOverlay(cp, blockAccess, blockState, blockPos, i, side, quad, j, renderEnv);
                    case 12 -> getConnectedTextureOverlayFixed(cp, quad, renderEnv);
                    case 13 ->
                            getConnectedTextureOverlayRandom(cp, blockAccess, blockState, blockPos, side, quad, renderEnv);
                    case 14 -> getConnectedTextureOverlayRepeat(cp, blockPos, side, quad, renderEnv);
                    case 15 ->
                            getConnectedTextureOverlayCtm(cp, blockAccess, blockState, blockPos, i, side, quad, j, renderEnv);
                    default -> null;
                };
            }
        }
    ...
    private static BlockDir[] getSideDirections(final int side, final int vertAxis) {
        return switch (side) {
            ...
            case 2 -> {
                if (vertAxis == 1) yield SIDES_Z_NEG_NORTH_Z_AXIS;
                yield SIDES_Z_NEG_NORTH;
            }
            case 3 -> SIDES_Z_POS_SOUTH;
            case 4 -> SIDES_X_NEG_WEST;
            case 5 -> {
                if (vertAxis == 2) yield SIDES_X_POS_EAST_X_AXIS;
    ...
    private static BlockDir[] getEdgeDirections(final int side, final int vertAxis) {
        return switch (side) {
            ...
            case 2 -> {
                if (vertAxis == 1) yield EDGES_Z_NEG_NORTH_Z_AXIS;
                yield EDGES_Z_NEG_NORTH;
            }
            case 3 -> EDGES_Z_POS_SOUTH;
            case 4 -> EDGES_X_NEG_WEST;
            case 5 -> {
                if (vertAxis == 2) yield EDGES_X_POS_EAST_X_AXIS;
    ...
    private static int getConnectedTextureCtmIndex(final ConnectedProperties cp, final IBlockAccess blockAccess, final IBlockState blockState, final BlockPos blockPos, final int vertAxis, final int side, final TextureAtlasSprite icon,
        ...
        if (i == 0) return i;
            ...
            else if (i == 25 && aboolean[0]) i = 30;
            else if (i == 27 && !aboolean[3] && aboolean[1]) i = 41;
            else if (i == 38 && aboolean[3]) i = 40;
            else if (i == 14 && aboolean[0]) i = 29;
            else if (i == 25 && aboolean[2]) i = 28;
            else if (i == 27 && aboolean[3]) i = 43;
            else if (i == 38 && aboolean[2]) i = 42;
            ...
            else if (i == 26 && aboolean[0] && aboolean[1] && aboolean[2]) i = 20;
            else if (i == 26 && aboolean[0] && aboolean[1]) i = 11;
            ...
            else if (i == 26 && aboolean[0] && aboolean[2]) i = 10;
            else if (i == 26 && aboolean[0] && aboolean[3]) i = 34;
            else if (i == 26 && !aboolean[0] && aboolean[1] && aboolean[2]) i = 35;
            else if (i == 26 && aboolean[0]) i = 32;
            else if (i == 26 && aboolean[1]) i = 33;
            else if (i == 26 && aboolean[2]) i = 44;
            else if (i == 26 && aboolean[3]) i = 45;
            return i;
        }
    }
    ...
    private static boolean isNeighbour(final ConnectedProperties cp, final IBlockAccess iblockaccess, final IBlockState blockState, final BlockPos blockPos, final IBlockState neighbourState, final int side, final TextureAtlasSprite icon,
        ...
        else if (!(neighbourState instanceof BlockStateBase blockstatebase)) return false;
        else {
    ...
    private static TextureAtlasSprite getNeighbourIcon(final IBlockAccess iblockaccess, final IBlockState blockState, final BlockPos blockPos, IBlockState neighbourState, final int side) {
        ...
        if (ibakedmodel == null) return null;
            ...
            if (list == null) return null;
                ...
                if (!list.isEmpty()) {
                    final BakedQuad bakedquad1 = list.getFirst();
                    ...
                    if (list1 == null) {
                        ...
                        for (final BakedQuad element : list1) {
                            final BakedQuad bakedquad = element;
    ...
    public static void updateIcons(final TextureMap textureMap) {
        ...
        if (Config.isConnectedTextures()) {
            ...
            final Location resourcelocation = Location.of("mcpatcher/ctm/default/empty");
    ...
    private static List makePropertyList(final ConnectedProperties[][] propsArr) {
        ...
        if (propsArr != null) for (final ConnectedProperties[] aconnectedproperties : propsArr) {
            List list1 = null;
            if (aconnectedproperties != null) list1 = new ArrayList(Arrays.asList(aconnectedproperties));
            list.add(list1);
        }
        return list;
    }
    ...
    private static boolean detectMultipass() {
        final List list = new ArrayList();
        for (final ConnectedProperties[] aconnectedproperties : tileProperties) {
            if (aconnectedproperties != null) list.addAll(Arrays.asList(aconnectedproperties));
        }
        for (final ConnectedProperties[] aconnectedproperties2 : blockProperties) {
            if (aconnectedproperties2 != null) list.addAll(Arrays.asList(aconnectedproperties2));
        }
        final ConnectedProperties[] aconnectedproperties1 = ((ConnectedProperties[]) list.toArray(new ConnectedProperties[0]));
    ...
    private static String[] getDefaultCtmPaths() {
        ...
        if (Config.isFromDefaultResourcePack(Location.of("textures/blocks/glass.png"))) {
            list.add(s + "glass.properties");
            list.add(s + "glasspane.properties");
        }
        if (Config.isFromDefaultResourcePack(Location.of("textures/blocks/bookshelf.png")))
            list.add(s + "bookshelf.properties");
        if (Config.isFromDefaultResourcePack(Location.of("textures/blocks/sandstone_normal.png")))
        ...
        for (int i = 0; i < astring.length; ++i) {
            ...
            if (Config.isFromDefaultResourcePack(Location.of("textures/blocks/glass_" + s1 + ".png"))) {
