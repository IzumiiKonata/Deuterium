...
public class RandomEntityRule {
    ...
    private Location baseResLoc = null;
    private final int index;
    private int[] textures = null;
    private Location[] resourceLocations = null;
    ...
    public RandomEntityRule(final Properties props, final String pathProps, final Location baseResLoc, final int index, final String valTextures, final ConnectedParser cp) {
    ...
    public boolean isValid(final String path) {
        if (this.textures != null && this.textures.length != 0) {
            if (this.resourceLocations != null) {
                ...
                this.resourceLocations = new Location[this.textures.length];
                final boolean flag = this.pathProps.startsWith("mcpatcher/mob/");
                final Location resourcelocation = RandomEntities.getLocationRandom(this.baseResLoc, flag);
                if (resourcelocation == null) {
                    ...
                    for (int i = 0; i < this.resourceLocations.length; ++i) {
                        ...
                        if (j <= 1) {
                            ...
                            final Location resourcelocation1 = RandomEntities.getLocationIndexed(resourcelocation, j);
    ...
    public Location getTextureLocation(final Location loc, final int randomId) {
