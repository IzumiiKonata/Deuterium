...
public class FontUtils {
    public static Properties readFontProperties(Location locationFontTexture) {
        ...
        if (s.endsWith(s1)) {
            ...
            try {
                Location resourcelocation = Location.of(locationFontTexture.getResourceDomain(), s2);
    ...
    public static Location getHdFontLocation(Location fontLoc) {
        if (!Config.isCustomFonts()) {
            ...
            if (!s.startsWith(s1)) {
                ...
                s = s2 + s;
                Location resourcelocation = Location.of(fontLoc.getResourceDomain(), s);
