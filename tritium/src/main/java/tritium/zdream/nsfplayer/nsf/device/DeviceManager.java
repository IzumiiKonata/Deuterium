package tritium.zdream.nsfplayer.nsf.device;

import static tritium.zdream.nsfplayer.core.ERegion.DENDY;
import static tritium.zdream.nsfplayer.core.ERegion.NTSC;
import static tritium.zdream.nsfplayer.core.ERegion.PAL;
import static tritium.zdream.nsfplayer.core.NsfStatic.BASE_FREQ_DENDY;
import static tritium.zdream.nsfplayer.core.NsfStatic.BASE_FREQ_NTSC;
import static tritium.zdream.nsfplayer.core.NsfStatic.BASE_FREQ_PAL;

import java.util.ArrayList;

import tritium.zdream.nsfplayer.core.ERegion;
import tritium.zdream.nsfplayer.core.IResetable;
import tritium.zdream.nsfplayer.nsf.audio.NsfAudio;
import tritium.zdream.nsfplayer.nsf.device.chip.NesAPU;
import tritium.zdream.nsfplayer.nsf.device.chip.NesDMC;
import tritium.zdream.nsfplayer.nsf.device.chip.NesFDS;
import tritium.zdream.nsfplayer.nsf.device.chip.NesMMC5;
import tritium.zdream.nsfplayer.nsf.device.chip.NesN163;
import tritium.zdream.nsfplayer.nsf.device.chip.NesS5B;
import tritium.zdream.nsfplayer.nsf.device.chip.NesVRC6;
import tritium.zdream.nsfplayer.nsf.device.chip.NesVRC7;
import tritium.zdream.nsfplayer.nsf.executor.IN163ReattachListener;
import tritium.zdream.nsfplayer.nsf.renderer.INsfRuntimeHolder;
import tritium.zdream.nsfplayer.nsf.renderer.NsfRendererConfig;
import tritium.zdream.nsfplayer.nsf.renderer.NsfRuntime;
import tritium.zdream.nsfplayer.sound.SoundN163;
