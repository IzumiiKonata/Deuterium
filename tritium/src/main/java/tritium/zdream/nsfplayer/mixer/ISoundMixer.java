package tritium.zdream.nsfplayer.mixer;
...
public interface ISoundMixer extends IResetable, INsfChannelCode {
	...
	/**
	 * <p>在运行中动态添加轨道
	 * <p>设计该方法的原因是 N163 轨道会在运行时动态添加.
	 * 在运行前你不知道 N163 芯片启动多少轨道, 然后莫名其妙它突然告诉你几个轨道能用,
	 * 然后就马上要使用了, 为了这种特殊需求加了这么一个方法
	 * </p>
	 * @param code
	 *   轨道号, 或者轨道类型号. 见静态成员 CHANNEL_*
	 */
	default void readyChannelInRuntime(byte code) {}
