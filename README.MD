<div align="center">
 <img src="tritium/src/main/resources/assets/minecraft/tritium/textures/logo_white.png" alt="Tritium Logo">
 <h1>Tritium-X</h1>
</div>
...
## 功能
- 本客户端使用了一个经过深度优化的 mcp919 base, 移除了
  - Twitch 直播
  - Snooper
  - Profiler
  - 成就系统
  ...
  - ...更多香草狗屎
- **低内存占用**
- **插件支持**: 实现了 **部分** Opai 扩展 API, 支持 Mixin
- **高性能**: 在同场景同视频设置中, 本客户端比市面上大多数 PVP 客户端 FPS 高出 `10%` ~ `50%`
- 更多内容自己看，我忘了。
## 性能
使用客户端内置的 `加载最优视频设置` 选项, 窗口大小为 `1600x900`  
超平坦世界, 开启结构生成并在村庄中测试, pitch 为 0

| CPU          | GPU                      | FPS        |
|--------------|--------------------------|------------|
| `i7-14700kf` | `RTX 3060`               | `~4000fps` |
| `i5-13500H`  | `Intel Iris Xe Graphics` | `~790fps`  |
...
___
### Alt Manager
![Alt Manager](res/altmanager.png)
___
### Click Gui
![Click Gui](res/clickgui.png)
___
### Music Screen
![Music Screen](res/musicscreen.png)
![Lyrics](res/lyrics.png)
### [Music Screen 演示视频](res/musicplayer.mp4)
___
### Resourcepack Preview
![Resourcepack Preview](res/respack%20preview.png)
