...
package tech.konata.obfuscator.exclusions;
...
public enum ExclusionType {
    ...
    PARAMETER_HIDER("ParameterHider"),
    METHOD_CALL_HIDER("MethodCallHider"),
    FLOW_OBFUSCATION("FlowObfuscation"),
    METHOD_HIDER("MethodHider"),
    LINE_NUMBERS("LineNumbers"),
    INNER_CLASS_EXTRACTOR("InnerClassExtractor"),
    LOCAL_VARIABLES("LocalVariables"),
    NUMBER_OBFUSCATION("NumberObfuscation"),
    HIDE_CODE("HideCode"),
    CLASS_FOLDER("ClassFolder"),
    CRC_FUCKER("CRCFucker"),
    CRASHER("Crasher"),
