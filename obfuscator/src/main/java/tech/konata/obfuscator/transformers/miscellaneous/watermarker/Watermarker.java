...
package tech.konata.obfuscator.transformers.miscellaneous.watermarker;
...
//                    if (counter > 20)
//                        throw new IllegalStateException("Obfuscator couldn't find any methods to embed a watermark in after " + counter + " tries.");
                ...
                if (hasInstructions(methodNode)) {
                    ...
                    Logger.stdOut("Injected watermark into " + methodNode.name + ", " + classWrapper.classNode.name);
                }
            }
        }
