...
public class LightStringEncryption extends StringEncryption {
    ...
    private class MemberNames {
        ...
        private MemberNames() {
            className = StringUtils.randomClassName(getClasses());
            clearSequencedString();
            cacheFieldName = nextSequencedString();
            clearSequencedString();
            cacheStringMethodName = nextSequencedString();
            returnCacheMethodName = nextSequencedString();
            cacheContainsMethodName = nextSequencedString();
            decryptMethodName = nextSequencedString();
        }
    }
