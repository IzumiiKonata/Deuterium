...
public class NormalStringEncryption extends StringEncryption {
    ...
    private class MemberNames {
        ...
        private MemberNames() {
            ...
            this.key1FieldName = nextSequencedString();
            this.key2FieldName = nextSequencedString();
            clearSequencedString();
            this.hashMethodName = nextSequencedString();
            this.returnCacheMethodName = nextSequencedString();
            this.cacheStringMethodName = nextSequencedString();
            this.decryptMethodName = nextSequencedString();
        }
    }
